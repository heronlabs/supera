...
This repo **is** a Claude Code plugin. It ships skills + agents that run in _other_ repos. Editing here changes behaviour everywhere supera is installed — treat it as load-bearing.
